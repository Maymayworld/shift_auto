      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              title: '1. 店舗情報の設定',
              content: 'まず、「店舗情報」からスキル、スタッフ、シフトパターンを登録してください。',
              steps: [
                'スキル情報：ホール、キッチンなど、必要なスキルを追加',
                'スタッフ情報：スタッフを追加し、それぞれが持つスキルを選択',
                'シフトパターン：早番、遅番などで必要なシフトを設定',
              ],
            ),
            _buildSection(
              title: '2. シフト希望の入力',
              ...
              steps: [
                '各マスを1回クリックするとシフト希望、2回クリックで配置、3回クリックでクリア',
                '編集アイコンをクリックして、スキルを選択',
                '各日付に対してもカスタムで必要なシフトを設定可能',
              ],
            ),
            _buildSection(
              title: '3. シフトの自動生成',
